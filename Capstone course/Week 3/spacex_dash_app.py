...
# Create a list of dictionaries, which have the keys 'label' and 'value' and the values should be the site name
site_options = []
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df, x="Payload Mass (kg)", y="class", color="Booster Version Category", title='Payload vs. Outcome for {}'.format(entered_site))
        return fig
